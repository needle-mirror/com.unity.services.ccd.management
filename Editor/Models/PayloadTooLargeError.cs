...
namespace Unity.Services.Ccd.Management.Models
{
    ...
    public class PayloadTooLargeError
    {
        ...
        [Preserve]
        public PayloadTooLargeError(string title = default, int status = default, string detail = default, string requestId = default)
        {
            Title = title;
            Status = status;
            Detail = detail;
        ...
        /// <summary>
        /// Parameter requestId of PayloadTooLargeError
        /// </summary>
        [Preserve]
