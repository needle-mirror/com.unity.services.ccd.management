...
namespace Unity.Services.Ccd.Management.Models
{
    ...
    public class TooManyRequestsError
    {
        ...
        [Preserve]
        public TooManyRequestsError(string title = default, int status = default, string detail = default, string requestId = default)
        {
            Title = title;
            Status = status;
            Detail = detail;
        ...
        /// <summary>
        /// Parameter requestId of TooManyRequestsError
        /// </summary>
        [Preserve]
