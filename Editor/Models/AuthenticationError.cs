...
namespace Unity.Services.Ccd.Management.Models
{
    ...
    public class AuthenticationError
    {
        ...
        [Preserve]
        public AuthenticationError(string title = default, int status = default, string detail = default, string requestId = default)
        {
            Title = title;
            Status = status;
            Detail = detail;
        ...
        /// <summary>
        /// Parameter requestId of AuthenticationError
        /// </summary>
        [Preserve]
