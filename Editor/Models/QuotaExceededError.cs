...
namespace Unity.Services.Ccd.Management.Models
{
    ...
    public class QuotaExceededError
    {
        ...
        [Preserve]
        public QuotaExceededError(string title = default, int status = default, string detail = default, string requestId = default)
        {
            Title = title;
            Status = status;
            Detail = detail;
        ...
        /// <summary>
        /// Parameter requestId of QuotaExceededError
        /// </summary>
        [Preserve]
