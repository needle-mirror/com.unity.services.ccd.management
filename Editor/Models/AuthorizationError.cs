...
namespace Unity.Services.Ccd.Management.Models
{
    ...
    public class AuthorizationError
    {
        ...
        [Preserve]
        public AuthorizationError(string title = default, int status = default, string detail = default, string requestId = default)
        {
            Title = title;
            Status = status;
            Detail = detail;
        ...
        /// <summary>
        /// Parameter requestId of AuthorizationError
        /// </summary>
        [Preserve]
